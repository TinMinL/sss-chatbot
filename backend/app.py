...
if api_key:
    ...
    # 使用 Gemini 1.5 Flash 模型，速度快且便宜，符合成本控制策略
    model = genai.GenerativeModel('gemini-1.5-flash')
else:
    model = None

# 初始化数据库 (整合了 init_db.py 的功能)
def init_db():
...
def chat():
    ...
    student_id = data.get('student_id', 'guest_student') # 模拟学生登录
    
    # 构建 Socratic 提示词 (模拟你们报告中的 Prompt Engineering)
    system_prompt = (
...
if __name__ == '__main__':
    print("Starting REAL AI Chatbot Backend Server on port 5000...")
